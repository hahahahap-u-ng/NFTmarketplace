...
export const NFTMarketplaceProvider = ({ children }) => {
  const titleData = "Khám phá, giao dịch NFT";
    ...
    if (file) {
      try {
        ...
        const response = await axios({
          ...
          data: formData,
          headers: {
            pinata_api_key: `6b0a19626ee7e89d64f8`,
            pinata_secret_api_key: `d952756111b058430dc6e6656da142c4db3310dc8c087cf0dd10bdf958f20f75`,
